create or replace function parse_html_table_tottori(
  p_html clob
)
...
begin
  -- 必要な情報までスキップ。
  l_html  := substr(p_html, instr(p_html, '【一覧】検査陽性者の属性'));
