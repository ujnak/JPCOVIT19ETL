 ...
 * 大阪府はXLSX
 */
create or replace procedure UPDATE_PATIENTS_OSAKA(
...
begin
    ...
    (
        ...
        select 
            ...
            "発症_年月日","患者_居住地","患者_年代","患者_性別","患者_症状"
    ...
    when not matched then
        insert(
            ...
            "公表_年月日","曜日","発症_年月日","患者_居住地",
            "患者_年代","患者_性別","患者_症状"
        )
        values(
            n.LINE_NO,n."全国地方公共団体コード",n."都道府県名",
            n."公表_年月日",n."曜日",n."発症_年月日",n."患者_居住地",
            n."患者_年代",n."患者_性別",n."患者_症状"
        );
    commit;
