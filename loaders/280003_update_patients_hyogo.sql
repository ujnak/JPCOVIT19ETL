...
begin
    ...
    (
        ...
        select 
            ...
            "発症_年月日","患者_居住地","患者_年代","患者_性別","患者_職業",
            "患者_渡航歴の有無フラグ","備考"
    ...
    when not matched then
        ...
        values(
            n.LINE_NO,n."全国地方公共団体コード",n."都道府県名",n."市区町村名",n."公表_年月日",n."曜日",
